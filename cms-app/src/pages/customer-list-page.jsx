...
import { Table, Breadcrumb, Button, ButtonGroup, Row, Col, InputGroup, Form, Dropdown, Card } from 'react-bootstrap';
...
function CustomerListPage() {
  const activeCustomers = [
    ...
    { id: 310, name: 'Jerry Stalder', subscription: 'U', car: '' },
    { id: 316, name: 'Mooney\'s Auto Restoration', subscription: 'U', car: '' },
  ];
            ...
            <Table hover className="user-table align-items-center">
                <thead>
                    <tr>
                        ...
                        <th className="border-bottom">Subscription Level</th>
                        <th className="border-bottom">ID</th>
                        <th className="border-bottom">Car Type</th>
                    </tr>
                </thead>
